...
//  Copyright © 2016 Lukas A. Mueller & Ilias Ennmouri. All rights reserved.
//
...
class PlayerViewController: UIViewController, UITableViewDataSource {
    ...
    func alertFavoriteUser() {
        ...
        detailLabel.text = "You are about to add \(username) to your favorites. This player will be displayed on the main screen."
